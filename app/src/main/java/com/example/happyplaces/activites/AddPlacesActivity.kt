...
class AddPlacesActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            R.id.et_date -> {
                DatePickerDialog(this@AddPlacesActivity, dateSetListener,
            ...
            R.id.btn_save -> {
                when{
                    et_title.text.isNullOrEmpty() ->{
                        Toast.makeText(this@AddPlacesActivity, "Please enter title", Toast.LENGTH_SHORT).show()
                    }
                    et_description.text.isNullOrEmpty() ->{
                        Toast.makeText(this@AddPlacesActivity, "Please enter description", Toast.LENGTH_SHORT).show()
                    }
                    et_location.text.isNullOrEmpty() ->{
                        Toast.makeText(this@AddPlacesActivity, "Please enter location", Toast.LENGTH_SHORT).show()
                    }
                    saveImageToInternalStorage == null ->{
                        Toast.makeText(this@AddPlacesActivity, "Please select the image", Toast.LENGTH_SHORT).show()
                    }
                    else ->{
            ...
            if(requestCode == GALLERY){
                if(data != null){
                    ...
                    try{
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddPlacesActivity,
